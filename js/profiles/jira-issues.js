...
(function() {
  ...
  projectNameSelector = '.project a';
  itemSelector = ".issuerow";
  itemDescriptionSelector = ".summary a";
  ...
  insertScript = function(callback) {
    ...
    var styles = '.harvest-timer.styled{border-radius:3px; border-color:#ddd}';
  ...
  addButton = function(element, data) {
    data['element'] = $(element).find('td:eq(0)');
    return sendMessage({
      'type': 'timers:request',
      'data': 'data',
      data: data
